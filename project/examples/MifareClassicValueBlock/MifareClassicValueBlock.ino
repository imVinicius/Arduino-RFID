 ...
 * ----------------------------------------------------------------------------
 * Este exemplo mostra como configurar blocos em um PICC MIFARE Classic (= cartão/etiqueta)
 * estar no modo "Bloco de Valor": neste modo as operações Incremento/Decremento,
